...
public final class Navigation {
	...
	public static final AbstractPage person = new SearchPagePerson();
	public static final AbstractPage course = new SearchPageCourse();
	public static final AbstractPage poi = new SearchPagePoI();
	public static final AbstractPage room = new SearchPageRoom();
	...
	public static void goToPage(AbstractPage page,String id){
		...
		RessourceLogger.logRessource(page, activePage);
